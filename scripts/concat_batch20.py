#!/usr/bin/env python3
"""Concatenate generated segment audio and mux with full videos for batch20."""

import json
import subprocess
from pathlib import Path

SEGMENT_OUTPUTS = Path("/data/SANA-WM-dataset/foley_omni_batch20/segment_outputs")
FULL_DIR = Path("/data/SANA-WM-dataset/foley_omni_batch20/full")
FINAL_DIR = Path("/data/SANA-WM-dataset/foley_omni_batch20/final_videos")
SUMMARY_PATH = Path("/data/SANA-WM-dataset/foley_omni_batch20/summary.json")
